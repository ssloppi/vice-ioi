...
uint16_t get_joystick_value(int index)
{
    ...
    if (!fire_button && joystickFireModEnabled) {
        fire_button = JOYPORT_BIT_BOOL(joystick_value[index], JOYPORT_FIRE_2_BIT) ||
                      JOYPORT_BIT_BOOL(joystick_value[index], JOYPORT_FIRE_3_BIT) ||
                      JOYPORT_BIT_BOOL(joystick_value[index], JOYPORT_FIRE_4_BIT);
    }
...
int joystick_init(void)
{
    ...
    resources_get_int("IOImode", &joystickFireModEnabled);
